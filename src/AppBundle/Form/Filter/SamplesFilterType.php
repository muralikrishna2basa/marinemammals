...
class SamplesFilterType extends AbstractType
{
    private $doctrine;
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('conservationMode', 'filter_choice', array(
            'empty_value' => 'Select...',
            'required' => false,
            'choice_list' => new CgRefChoiceList($this->doctrine, 'CONSERVATION_MODE')
        ));
    }
