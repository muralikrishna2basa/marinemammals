 ...
 * @ORM\Entity(repositoryClass="AppBundle\Entity\Repository\PlatformsRepository")
 */
class Platforms
{
    /**
     ...
     * Set pfmType
     *
     * @param string $pfmType
     * @return Platforms
     */
    public function setPfmType($pfmType)
    {
