...
class Specimens
{
     ...
     * @return Specimens
     */
    public function addEseSeqno(\AppBundle\Entity\EventStates $eseSeqno)
    {
     ...
     * @param \AppBundle\Entity\EventStates $eseSeqno
     */
    public function removeEseSeqno(\AppBundle\Entity\EventStates $eseSeqno)
    {
        $this->eseSeqno->removeElement($eseSeqno);
    }
