...
$css = "/legacy/css/observation_flow_four.css";

$js = "/legacy/js/observation_flow_four.js";
...
if(isset($_POST['obsfileimgs']))
{
	$fileimgs = $_POST['obsfileimgs'];
}
else 
{
	$fileimgs = array();
...
<?php
	while($row = $res->fetch())
	{
		...
		</div><div class='image'><input style='display:none;' name = 'obsfileimgs[]'value='$imgsrc'/><img alt='$filename' src='$imgsrc'></div></div>";
		}
	}
?>
<input style='display:none;' name = 'obsfileimgs[]'value=''/> 
</fieldset>
