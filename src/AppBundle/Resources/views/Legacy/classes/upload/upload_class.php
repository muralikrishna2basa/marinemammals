...
class Uploads extends Upload 
{
	...
	public function __toString()
	{
			...
			$tostring .= "<div class='initinput'><div><input type='file' name='upload[]' size='30'/>".
						 "<button type='button' class='del'><img src='/legacy/img/cross.png' alt='Del'/></button></div></div>";
			...
			{
			$tostring .= "<div><input type='file' name='upload[]' size='30'/><button type='button' class='del'><img src='/legacy/img/cross.png' alt='Del' /></button></div>";
			}
			else 
			{
