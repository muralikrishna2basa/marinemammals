...
Class Tree_Element 
{
	...
	public function __toString()
	{
		...
		return "<img class='item expander' alt='expand' src='/legacy/img/Container_Localizations/expander.gif'/>".
								 "<img class='item collapser' alt='expand' src='/legacy/img/Container_Localizations/collapser.gif' style='display:none;'/>".
								(is_bool($this->image)==true?"":"<img  alt='container' src='/legacy/img/Container_Localizations/$this->image'/>").
