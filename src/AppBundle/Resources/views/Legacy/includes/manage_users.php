...
$Layout->addHead(array('<script type="text/javascript" src="/legacy/js/jquery.maskedinput-1.2.2.js"></script>',
					   '<script type="text/javascript" src="/legacy/js/manage_user.js"></script>',
					   '<link rel="stylesheet" type="text/css" href="/legacy/css/manage_users.css" />'));
