...
$Layout->addHead(array('<link rel="stylesheet" type="text/css" href="/legacy/css/import_manage_stations.css" />',
						'<script type="text/javascript" src="/legacy/js/import_manage_stations.js"></script>',
						));
