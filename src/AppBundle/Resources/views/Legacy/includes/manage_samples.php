...
$Layout->addHead(array('<script type="text/javascript" src="/legacy/js/manage_samples.js"></script>',
					    '<link rel="stylesheet" type="text/css" href="/legacy/css/manage_samples.css" />'));
