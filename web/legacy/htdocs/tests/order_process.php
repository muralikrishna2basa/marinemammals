...
if(!isset($_SESSION['samples']) == true || count($_SESSION['samples']) == 0 )
{
	// remove navigation set, 
	$navigation = $_SESSION['navigation'];
	unset($navigation['/Biobank.php']);
	$_SESSION['navigation'] = $navigation; // reset navigation list 
...
{
	$navigation = $_SESSION['navigation'];
	$navigation['/Biobank.php'] = '#description_biobank';
	$_SESSION['navigation'] = $navigation; // reset navigation list 
...
echo "Your order has been successfully entered<br> The team in charge will proceed your request has soon as possible";	
