...
class Table_Renderer extends BLP_Renderer
{
    ...
    public function setHeader()
    {
        ...
        $sort_up = "<img width='12' height='12' class='sortleft'  alt='sort up' src='/img/upac.png'/>";
        $sort_down = "<img width='12' height='12' class='sortright' alt='sort down' src='/img/downac.png'/>";

        $sorted_up = "<img width='12' height='12' class='sortleft' alt='sorted up' src='/img/up.png'/>";
        $sorted_down = "<img width='12' height='12' class='sortright' alt='sorted down' src='/img/down.png'/>";
