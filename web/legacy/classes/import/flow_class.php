...
//	}
	...
	public function getButtonImage($name)
	{
		switch($name)
		{
			case 'refresh':return "<img alt='refresh' src='/img/Container_Localizations/refresh.png'></img>";
			case 'home':return "<img alt='home' src='/img/Container_Localizations/stop.png'></img>";
			case 'next':return "<img alt='NEXT' src='/img/next.png'></img>";
			case 'previous':return "<img alt='PREV' src='/img/previous.png'></img>";
		}
	}
