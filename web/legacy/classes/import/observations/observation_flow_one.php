...
$css = "css/observation_flow_one.css";

$js = "js/observation_flow_one.js";
//
...
if($val->getStatus())
{
   ...
   // convert latitude & longitude to database format
    $latitude = str_replace(array('째','�','\'','\'\''),array("/","/","/",""),$val->getValue('station_latitude_freecoord'));
	
    $longitude =str_replace(array('째','�','\'','\'\''),array("/","/","/",""),$val->getValue('station_longitude_freecoord'));
