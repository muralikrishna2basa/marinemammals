...
class Biolibd_Layout extends Twocolfixedfluid
{
    ...
    public function __construct($offline = false, $redirect_url = 'index.php')
    {
       ...
       Twocolfixedfluid::__construct("Marine Mammals");
        ...
        $this->addHead(array('<script type="application/javascript" src="js/jquery-1.4.2.min.js"></script>',
            '<script type="application/javascript" src="js/jquery.json-2.2.js"></script>',
            '<script type="application/javascript" src="js/Layout.js"></script>',
            '<script type="application/javascript" src="js/navigation.js"></script>',
            '<script type="application/javascript" src="js/jquery.contextMenu.js"></script>',
            '<script type="application/javascript" src="js/jquery.datepick.js"></script>',
            '<script type="application/javascript" src="js/jquery-ui-1.7.2.custom.js"></script>',
            '<script type="application/javascript" src="js/ui.core.js"></script>',
            '<script type="application/javascript" src="js/ui.accordion.js"></script>',
            '<script type="application/javascript" src="js/jquery.loadmask.adapted.js"></script>',
