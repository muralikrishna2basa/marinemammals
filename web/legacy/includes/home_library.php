...
$Layout->addHead(array('<link rel="stylesheet" type="text/css" href="css/Record.css" />',
...
//
//$pic = $record->addElement('pic',array('src'=>'img/tmp_ulg_tr80.png','alt'=>'Johan Pic','class'=>array('test','boo')));
