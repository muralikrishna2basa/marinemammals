...
$Layout->addHead(array('<link href="css/container_localizations_tree.css" rel="stylesheet" type="text/css" />',
//							'<script type="text/javascript" src="js/jquery.event.drag-1.5.js"></script>',
//							'<script type="text/javascript" src="js/jquery.event.drop-1.2.js"></script>',
							'<script type="text/javascript" src="js/container_localizations_tree.js"></script>'));
...
?>
	...
	<form class='cms' method="POST" action=<?php $_SERVER['PHP_SELF'];?>>
		...
		<div class ="row">
			...
			<div class = "element">
				<button class="submit" name ="Add"><img alt='accept' src='img/accept.png'></img></button>
			</div>
		</div>
		<div class ="row">
			<div class="element">
			...
			<div class ="element">
				<button class="submit" name ="Updatevalue"><img alt='accept' src='img/accept.png'></img></button>
			</div>
		</div>
		<div class ="row">
					<div class="element">
			...
			<div class = "element">
				<button class="submit" name ="Updateroot"><img alt='accept' src='img/accept.png'></img></button>
			</div>
		</div>
		<div class ="row">
			<div class="element">
			...
			<div class = "element">
				<button class="submit" name ="Delete"><img  alt='accept' src='img/accept.png'></img></button>
			</div>	
		</div>
		<div class="row">
