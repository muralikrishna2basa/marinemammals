...
$Layout->addHead(array('<link rel="stylesheet" type="text/css" href="css/home_partners.css" />',
						'<link rel="stylesheet" type="text/css" href="css/autopsy_import/autopsy_samples.css" />',
						'<script type="text/javascript" src="js/autopsy_import/autopsy_samples.js"></script>',
						'<script type="text/javascript" src="js/home_partners.js"></script>',
						));
