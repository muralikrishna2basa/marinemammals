...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            ...
            'kernel.bundles' => array(
                ...
                'TaxaBundle' => 'TaxaBundle\\TaxaBundle',
            ...
            'database_host' => 'ora.mumm.ac.be',
            'database_port' => 1521,
            'database_name' => 'biolibp',
            'database_user' => 'THOMAS',
            'database_password' => 'Thomas2014',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_oci', 'host' => 'ora.mumm.ac.be', 'port' => 1521, 'dbname' => 'biolibp', 'user' => 'THOMAS', 'password' => 'Thomas2014', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array((dirname(dirname(dirname(__DIR__))).'/src/AppBundle/Resources/config/doctrine') => 'AppBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d261c842cf81203fab9ed1ed0c4a37334d9fd02cfa0a706f2f718aa1632994e5');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/TaxaBundle/Resources/views'), 'Taxa');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings(array(0 => (dirname(dirname(dirname(__DIR__))).'/src/AppBundle/Resources/config/validation.yml')));
